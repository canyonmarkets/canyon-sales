...
export default function SplashScreen({ onDone }: { onDone: () => void }) {
  ...
  return (
    ...
    >
      <div style={{ animation: 'splashLogo 1.1s cubic-bezier(0.22,1,0.36,1) both', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="brand-title" style={{
          marginTop: 18, fontSize: 40, color: '#fff',
        ...
        <div style={{
          ...
          color: 'var(--ember)', fontWeight: 600, paddingLeft: '0.42em',
        }}>
          Sales
        </div>
      </div>
